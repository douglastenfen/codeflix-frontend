...
const MovieCard = ({ movie }: { movie: Movie }) => (
  <div className='group relative min-h-[12vh] rounded bg-zinc-900 md:min-h-[12vw]'>
    ...
    <div className='invisible absolute top-0 z-10 w-full min-w-[20vw] scale-0 opacity-0 transition duration-200 group-hover:-translate-y-[6vw] group-hover:scale-110 group-hover:opacity-100 sm:visible'>
      {/* <video
        autoPlay
        loop
        muted
        className='duration cuersor-pointer h-[12vw] w-full rounded-t-md object-cover object-top shadow-xl transition'
      ...
      <div className='absolute z-10 w-full rounded-b-md bg-zinc-800 p-2 shadow-md transition lg:p-4'>
        ...
        <div className='mt-4 flex flex-col gap-2 text-sm'>
          ...
          <div className='flex flex-row items-center gap-2'>
            <UserGroupIcon className='w-4' />{' '}xpto
